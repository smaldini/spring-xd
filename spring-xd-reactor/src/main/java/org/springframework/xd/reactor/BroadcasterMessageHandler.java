...
public class BroadcasterMessageHandler extends AbstractMessageProducingHandler  implements DisposableBean {
    ...
    protected void handleMessageInternal(Message<?> message) throws Exception {
        ...
        if (null == inputType || ClassUtils.isAssignable(inputType, message.getClass())) {
    ...
    public void destroy() throws Exception {
        ...
        System.out.println(Thread.currentThread()+" destroy "+processorSubscription);
        if(processorSubscription != null){
            this.processorSubscription = null;
            logger.debug("Destroying Reactor Module");
